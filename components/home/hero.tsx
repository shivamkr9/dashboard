        ...
        <div>
            ...
            <div className='flex flex-col pb-8 md:justify-start justify-center md:items-start items-center'>
                <div className='py-14 px-8'>
                    <h1 className='md:text-[40px] text-[24px] font-bold text-[#3E3A51] font-archivo'>Hey student name,</h1>
                    <p className='text-muted-foreground font-normal md:text-2xl text-[12px]'>Let's Achieve Greatness Today!</p>
                </div>
